...
class PaymentPolicy
{
    ...
    protected $BaseModel = 'InvoicePayment';
    protected $ability = '';
     ...
     * @return mixed
     */
    public function view(User $user, InvoicePayment $payment)
    {
     ...
     * @return mixed
     */
    public function update(User $user, InvoicePayment $payment)
    {
        if ($user->companyId != func_get_arg(1)->companyId) {
            return false;
        }
     ...
     * @return mixed
     */
    public function delete(User $user, InvoicePayment $payment)
    {
        if ($user->companyId != func_get_arg(1)->companyId) {
            return false;
        }
